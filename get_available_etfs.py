...
class GetAvailableEtfs:
    ...
    @staticmethod
    def fetch_content(etf_list_url, wait_time = 5000):
        """
    ...
    @staticmethod
    def parse_etf_table(content):
        """
        Parse the HTML content and extract ETF data into a DataFrame.
        :param content: HTML content from fetch_content
...
if __name__ == "__main__":
    ...
    url_edit = get.asset_class_select("equity")
    print(f"Fetching: {url_edit}")
    content = get.fetch_content(url_edit)
